...
public class Checkout extends JFrame implements ActionListener{
    ...
    Choice ccustomer;
    JLabel lblroomno,lblchecktime,lblcheckouttime;
    ...
    Checkout(){
        ...
        lblchecktime=new JLabel();
        lblchecktime.setBounds(150,180,100,30);
        add(lblchecktime);
        ...
        try{
            ...
            while(rs.next()){
                ...
                lblchecktime.setText(rs.getString("checkintime"));
